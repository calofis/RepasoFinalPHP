    ...
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
                ...
                if (isset($_SESSION['permisos']['Categorias']) && strpos($_SESSION['permisos']['Categorias'], 'r') !== false) {
                    ?>
                    <li class="nav-item">
        ...
        <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
                ...
                <?php } if (isset($_SESSION['permisos']) && strpos($_SESSION['permisos']['Categorias'], 'r') !== false) { ?>
                <li class="nav-item">
